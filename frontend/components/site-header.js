          ...
          <div className="flex items-center justify-between gap-3">
            <Link href="/" className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="hidden text-xs font-semibold text-muted sm:block">Tools market</p>
              </div>
            </Link>
            ...
            >
              <span className="flex w-5 flex-col gap-1">
                ...
                />
                <span className={`h-0.5 rounded-full bg-foreground transition ${menuOpen ? "opacity-0" : ""}`} />
                <span
                  className={`h-0.5 rounded-full bg-foreground transition ${
                    menuOpen ? "-translate-y-1.5 -rotate-45" : ""
                  }`}
              ...
              return (
                <Link
                  ...
                  className={`rounded-xl px-4 py-3 text-sm font-semibold ${
                    active ? "bg-accent-strong text-slate-950 shadow-sm" : "text-muted-strong hover:bg-yellow-50"
                  }`}
                >
                  {link.label}
                </Link>
